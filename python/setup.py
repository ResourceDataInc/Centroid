...
setup(name = 'centroid',
      ...
      long_description = 'Centroid is library for loading configuration values declared in JSON, and accessing those configuration values using object properties.',
